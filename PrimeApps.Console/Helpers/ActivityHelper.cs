			...
			using (var _scope = _serviceScopeFactory.CreateScope())
			{
				...
				using (var _reminderRepository = new ReminderRepository(databaseContext, _configuration))
				{
					...
					Reminder reminder = new Reminder()
					{
						...
						//TODO Rev = Utils.CreateRandomString(20),
					...
					if (newReminder != null)
					{
						...
						//TODO Hangfire.BackgroundJob.Schedule<Jobs.Reminder.Activity>(activity => activity.Process(reminderDto, appUser), dateOffset);
					}
				}
			}
		}
			...
			using (var _scope = _serviceScopeFactory.CreateScope())
			{
				...
				using (var _reminderRepository = new ReminderRepository(databaseContext, _configuration))
				{
					...
					if (updatedReminder != null)
					{
						...
						//TODO Hangfire.BackgroundJob.Schedule<Jobs.Reminder.Activity>(activity => activity.Process(reminder, appUser), dateOffset);
					}
				}
			}
