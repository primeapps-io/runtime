...
angular.module('primeapps')
    ...
    .controller('FunctionsDeploymentController', ['$rootScope', '$scope', '$filter', '$state', '$stateParams', '$modal', '$timeout', 'helper', 'dragularService', 'DeploymentService', 'LayoutService', '$http', 'config',
