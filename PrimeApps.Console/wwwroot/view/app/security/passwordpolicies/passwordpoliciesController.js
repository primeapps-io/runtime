...
angular.module('primeapps')
    ...
    .controller('PasswordPoliciesController', ['$rootScope', '$scope', '$filter', '$state', '$stateParams', '$modal', '$timeout', 'helper', 'dragularService', 'PasswordPoliciesService', 'LayoutService', '$http', 'config',
