            ...
            using (var _scope = _serviceScopeFactory.CreateScope())
            {
                ...
                using (var _analyticRepository = new AnalyticRepository(databaseContext, _configuration))
                {
                    ...
                    using (var _recordHelper = new RecordHelper(_configuration, _serviceScopeFactory, _currentUser))
                    {
                        ...
                        var resultBefore = await _recordHelper.BeforeCreateUpdate(moduleActivity, task, modelState, appUser.Language, _moduleRepository, _picklistRepository, _profileRepository, _tagRepository, _settingRepository, _recordRepository, appUser: appUser);
