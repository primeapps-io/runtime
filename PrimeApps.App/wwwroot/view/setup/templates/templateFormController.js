...
angular.module('primeapps')
    ...
    .controller('TemplateFormController', ['$rootScope', '$scope', '$filter', '$state', '$location', 'helper', 'config', '$localStorage', 'TemplateService', '$cookies', 'mdToast',
        function ($rootScope, $scope, $filter, $state, $location, helper, config, $localStorage, TemplateService, $cookies, mdToast) {
            ...
            var success = function () {
                ...
                mdToast.success($filter('translate')('Setup.Templates.SaveSuccess'));
            };
