                            ...
                            $q.all(promises)
                                .then(function (response) {
                                    if (response.length < 6
                                        ...
                                        (refresh && (response[13].status !== 200 || !response[13].data)) || !response[0].data || !response[1].data || !response[2].data || !response[3].data) {
                                        clearAuthCache();
                                        deferred.resolve(false);
                                        return deferred.promise;
                                    }
                                    ...
                                    if (refresh && response[13] && response[13].data)
                                    ...
                                    for (var moduleKey = modules.length - 1; moduleKey >= 0; moduleKey--) {
                                        ...
                                        for (var fieldKey = modules[moduleKey].fields.length - 1; fieldKey >= 0; fieldKey--) {
                                            ...
                                            if (modules[moduleKey].fields[fieldKey].primary) {
