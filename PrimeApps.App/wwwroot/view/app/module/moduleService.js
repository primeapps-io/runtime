            ...
            return {
                ...
                lookup: function (searchTerm, field, record, additionalFields, exactMatch) {
                    ...
                    if (lookupModule.name === 'users' || ($rootScope.branchAvailable && lookupType === 'branchs')) {
                        ...
                        findRequest.filters.push({ field: 'is_active', operator: 'equals', value: true, no: filterOrderNo }, { field: 'email', operator: 'not_contain', value: "integration_", no: filterOrderNo+1 });
                    }
