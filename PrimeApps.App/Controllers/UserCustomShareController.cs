...
namespace PrimeApps.App.Controllers
{
	...
	public class UserCustomShareController : ApiBaseController
    {
		...
		{
			SetContext(context);
			SetCurrentUser(_userOwnerRepository, PreviewMode, TenantId, AppId);
        ...
        public async Task<IActionResult> Update(int id, [FromBody]UserCustomShareBindingModels userOwner)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
