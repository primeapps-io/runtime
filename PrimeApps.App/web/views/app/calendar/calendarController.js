                ...
                if ($scope.modules.length > 0) {
                    angular.forEach($scope.modules, function (module) {
                        ...
                        if (!$scope.permissions[module.name])
                            $scope.permissions[module.name] = $filter('filter')($rootScope.user.profile.Permissions, {ModuleId: module.id}, true)[0];
