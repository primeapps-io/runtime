    ...
    .directive('noteList', ['convert', '$localStorage', 'NoteService', 'FileUploader', 'config', 'ngToast', '$filter', 'helper', '$modal',
        function (convert, $localStorage, NoteService, FileUploader, config, ngToast, $filter, helper, $modal) {
            return {
                ...
                templateUrl: cdnUrl + 'web/views/app/note/noteList.html',
                controller: ['$rootScope', '$scope', function ($rootScope, $scope) {
                    ...
                    $scope.addNote = function (noteModel) {
                        if (!noteModel || !noteModel.text.trim())
                            return;
                    ...
                    $scope.addComment = function (noteModel) {
                        if (!noteModel.subNote.text || !noteModel.subNote.text.trim())
                            return;
                    ...
                    $scope.updateNote = function (noteModel) {
                        if (!noteModel.text || !noteModel.text.trim())
                            return;
                    ...
                    $scope.deleteNote = function (note, parentNote) {
                    ...
                    $scope.noteLikesList = function (likes) {
                        $scope.likes = likes;
                        $scope.noteLikes = $scope.noteLikes || $modal({
                            scope: $scope,
                            templateUrl: 'web/views/app/note/noteLikes.html',
                            animation: '',
                            backdrop: 'static',
                            show: false,
                            tag: 'createModal'
                        ...
                        $scope.noteLikes.$promise.then($scope.noteLikes.show);
                    };
    ...
    .directive('noteForm', ['$filter', '$localStorage', 'FileUploader', 'config', 'convert', 'entityTypes', 'NoteService', 'ngToast',
        function ($filter, $localStorage, FileUploader, config, convert, entityTypes, NoteService, ngToast) {
            return {
                ...
                templateUrl: cdnUrl + 'web/views/app/note/noteForm.html',
