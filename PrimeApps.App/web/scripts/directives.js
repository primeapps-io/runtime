...
angular.module('ofisim')
                    ...
                    element.bind('click', function () {
                        $timeout(function () {
                            ...
                            var popover = $popover(element, {
                                ...
                                trigger: 'manual',
                                autoClose: true,
                                contentTemplate: 'web/views/common/confirm.html' + '?v=' + version
                            });
    ...
    .directive('subTable', ['$rootScope', 'ngTableParams', 'ngToast', 'blockUI', '$filter', '$cache', 'helper', 'exportFile', 'operations', 'ModuleService',
        function ($rootScope, ngTableParams, ngToast, blockUI, $filter, $cache, helper, exportFile, operations, ModuleService) {
            return {
                ...
                templateUrl: 'web/views/common/subtable.html?v=' + version,
                controller: ['$scope',
                    function ($scope) {
                        $scope.loading = true;
    ...
    .directive('trial', ['$rootScope', '$modal', '$http', 'config', '$filter', 'ngToast',
        function ($rootScope, $modal, $http, config, $filter, ngToast) {
            return {
                restrict: 'EA',
                templateUrl: 'web/views/app/trial/trial-box.html?v=' + version,
                controller: ['$scope',
                    function ($scope) {
                        $scope.promotion = {
    ...
    .directive('zxPasswordMeter', ['$filter', function ($filter) {
        return {
            ...
            templateUrl: 'web/views/common/password-meter.html?v=' + version,
            link: function (scope) {
                scope.type = '';
