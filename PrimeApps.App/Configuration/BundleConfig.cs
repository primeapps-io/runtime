    ...
    public partial class Startup
    {
	    public static void RegisterBundle(IServiceCollection services)
	    {
			services.AddWebOptimizer(pipeline =>
			{
				...
				pipeline.AddBundle("/scripts/bundles-js/apps1.js", "text/javascript; charset=UTF-8",
					"/scripts/app.js",
					...
					"/views/app/phone/sipPhoneController.js").Concatenate();

				pipeline.AddBundle("/scripts/bundles-js/vendor.js", "text/javascript; charset=UTF-8",
					...
					"/scripts/vendor/moment-weekdaysin.js").Concatenate();
