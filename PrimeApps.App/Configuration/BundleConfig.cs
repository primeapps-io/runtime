...
namespace PrimeApps.App
{
    public partial class Startup
    {
	    ...
	    public static void RegisterBundle(IServiceCollection services)
	    {
			...
			{
				pipeline.AddJavaScriptBundle("/web/bundles-js/auth.js",
					...
					"/web/scripts/vendor/ladda.js").UseContentRoot();

				pipeline.AddJavaScriptBundle("/web/bundles-js/vendor.js",
					...
					"/web/scripts/vendor/moment-weekdaysin.js").UseContentRoot();

				pipeline.AddJavaScriptBundle("/web/bundles-js/app.js",
					"/web/scripts/app.js",
					...
					"/web/views/app/crm/phone/sipPhoneController.js").UseContentRoot();

				pipeline.AddCssBundle("/web/bundles-css/auth.css",
					"/web/styles/vendor/bootstrap.css",
					"/web/styles/vendor/flaticon.css",
					"/web/styles/vendor/ladda-themeless.css",
					"/web/styles/vendor/font-awesome.css").UseContentRoot();

				pipeline.AddCssBundle("/web/bundles-css/vendor.css",
					...
					"/web/styles/ui.css").UseContentRoot();

				pipeline.AddCssBundle("/web/bundles-css/app.css",
					"/web/styles/app.css").UseContentRoot();
			});
		}
    }
}
