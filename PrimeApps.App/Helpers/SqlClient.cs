...
{
    //next NHIBERNATE to EF Migration with DI.
    public class SqlClient<TObject> where TObject : class
    {
        protected PlatformDBContext _context;

        public SqlClient(PlatformDBContext context)
        {
            _context = context;
        }
