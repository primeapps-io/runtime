...
namespace PrimeApps.App.Helpers
{
	...
	public class ProcessHelper : IProcessHelper
	{
		...
		public ProcessHelper(IModuleRepository moduleRepository, IPicklistRepository picklistRepository, IWorkflowHelper workflowHelper, ICalculationHelper calculationHelper, IProcessRequestRepository processRequestRepository, IProcessRepository processRepository, IRecordRepository recordRepository, IUserRepository userRepository, IHttpContextAccessor context, IConfiguration configuration)
		{
			_context = context;
			...
			_userRepository.CurrentUser = _recordRepository.CurrentUser = _picklistRepository.CurrentUser = _moduleRepository.CurrentUser = UserHelper.GetCurrentUser(_context);
