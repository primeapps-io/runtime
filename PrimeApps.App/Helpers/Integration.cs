...
namespace PrimeApps.App.Helpers
{
    public static class Integration
    {
        public static async Task InsertSubscriber(RegisterBindingModel model, Warehouse warehouse, IConfiguration configuration)
        {
			...
			//                    try
			//                    {
			//                         var resultUpdate = await recordRepository.Update(accountCurrent, moduleAccount, isUtc: false);
			...
			//                    try
			//                    {
			//                        var resultUpdate = await recordRepository.Update(contactCurrent, moduleContact, isUtc: false);
		...
		public static async Task UpdateSubscriber(string userEmail, int tenantId, Warehouse warehouse, IConfiguration configuration)
        {
			...
			//                try
			//                {
			//                    var resultUpdate = await recordRepository.Update(contact, moduleContact, isUtc: false);
			...
			//                try
			//                {
			//                    var resultUpdate = await recordRepository.Update(account, moduleAccount, isUtc: false);
