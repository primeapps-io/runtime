...
namespace PrimeApps.App.Helpers
{
    ...
    public class DocumentHelper : IDocumentHelper
    {
        ...
        public DocumentHelper(IConfiguration configuration, IServiceScopeFactory serviceScopeFactory)
        {
        ...
        public async Task<int> UploadSampleDocuments(Guid instanceId, int appId, string language)
        {
            using (var _scope = _serviceScopeFactory.CreateScope())
            {
                ...
                using (var platformRepository = new PlatformRepository(databaseContext, _configuration))
                {
                    var templates = await platformRepository.GetAppTemplate(appId, AppTemplateType.Document, language, null);
