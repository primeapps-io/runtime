...
namespace PrimeApps.App.Helpers
{
    ...
    public class CalculationHelper : ICalculationHelper
    {
                                    ...
                                    using (var recordRepository = new RecordRepository(databaseContext, warehouse, _configuration))
                                    {
                                        ...
                                        switch (module.Name)
                                        {
                                            ...
                                            */
                                                if (isBranch != null && isBranch.Value == "t")
                                                {
                                                    await ChangeRecordOwner(record["e_posta"].ToString(), record, module, recordRepository, moduleRepository);
        ...
        public static async Task<bool> ChangeRecordOwner(string email, JObject calisanRecord, Module calisanModule, RecordRepository recordRepository, ModuleRepository moduleRepository)
        {
