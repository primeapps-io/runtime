...
namespace PrimeApps.App.Helpers
{
    ...
    public class CalculationHelper : ICalculationHelper
    {
        ...
        public async Task Calculate(int recordId, Module module, UserItem appUser, Warehouse warehouse, OperationType operationType, BeforeCreateUpdate BeforeCreateUpdate, AfterUpdate AfterUpdate, GetAllFieldsForFindRequest GetAllFieldsForFindRequest)
        {
            try
            {
                                ...
                                switch (module.Name)
                                {
									...
									case "project_indicators":
                                        ...
                                        try
                                        {
                                            ...
                                            await Calculate((int)projectScopeUpdateRecord["id"], projectScopeModule, appUser, warehouse, operationType, BeforeCreateUpdate, AfterUpdate, GetAllFieldsForFindRequest);
                                        }
                                        catch (Exception ex)
                                        {
                                            //ErrorLog.GetDefault(null).Log(new Error(ex));
