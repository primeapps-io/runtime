...
namespace PrimeApps.App.Helpers
{
	...
	public class WorkflowHelper : IWorkflowHelper
	{
		...
		public WorkflowHelper(IPicklistRepository picklistRepository, IModuleRepository moduleRepository, IWorkflowRepository workflowRepository, IRecordRepository recordRepository, IUserRepository userRepository, IHttpContextAccessor context, IConfiguration configuration)
		{
			_context = context;
			...
			_userRepository.CurrentUser = _workflowRepository.CurrentUser = _picklistRepository.CurrentUser = _moduleRepository.CurrentUser = UserHelper.GetCurrentUser(_context);
					...
					try
					{
						...
						using (var client = new HttpClient())
						{
							...
							if (webHook.Parameters != null)
							{
								...
								recordData = await Model.Helpers.RecordHelper.FormatRecordValues(module, recordData, _moduleRepository, _picklistRepository, _configuration, tenant.Tenant.Setting.Language, subscriber.Setting.Culture, 180, lookupModules);
