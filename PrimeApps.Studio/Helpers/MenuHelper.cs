...
namespace PrimeApps.Studio.Helpers
{
    public static class MenuHelper
    {
        ...
        public static MenuItem CreateMenuItems(JObject request, Menu menu, Module moduleEntity, MenuItem parent, bool step3 = false)
        {
            ...
            //first 1.1
            if (menu != null && moduleEntity == null && parent == null &&
                string.IsNullOrEmpty((string) request["route"]) && !step3)
            {
            ...
            else if ((int) request["menuId"] > 0 && parent != null) //menu != null && moduleEntity != null && 
            {
                ...
                if (!string.IsNullOrEmpty(moduleName))
                {
                    ...
                    bool
                        value = (bool) request[
                            "isDynamic"]; //moduleEntity != null ? (moduleEntity.SystemType.HasFlag(SystemType.System) ? false : true) : false;
                    menuItem = new MenuItem()
                    {
                        MenuId = menu.Id,
