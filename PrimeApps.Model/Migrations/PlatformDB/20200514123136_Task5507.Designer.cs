...
namespace PrimeApps.Model.Migrations.PlatformDB
{
    ...
    [Migration("20200514123136_Task5507")]
    partial class Task5507
    {
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Platform.AppSetting", b =>
                {
                    ...
                    b.Property<string>("PicklistLanguage")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("picklist_language")
                        .HasDefaultValue("en");
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Platform.AppTemplate", b =>
                {
                    ...
                    b.HasIndex("AppId", "SystemCode", "Language")
                        .IsUnique();
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Platform.PlatformUser", b =>
                {
                    ...
                    b.Property<string>("IntegrationUserClientId")
                        .HasColumnName("integration_user_client_id");
