...
namespace PrimeApps.Model.Migrations.TenantDB
{
    ...
    [Migration("20180406162854_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Application.FieldCombination", b =>
                {
                    b.HasOne("PrimeApps.Model.Entities.Application.Field")
                        .WithOne("Combination")
                        .HasForeignKey("PrimeApps.Model.Entities.Application.FieldCombination", "Combination")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Application.FieldValidation", b =>
                {
                    ...
                    b.HasOne("PrimeApps.Model.Entities.Application.Field")
                        .WithOne("Validation")
                        .HasForeignKey("PrimeApps.Model.Entities.Application.FieldValidation", "Validation")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Application.Note", b =>
                {
                    ...
                    b.HasOne("PrimeApps.Model.Entities.Application.Note")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Application.WorkflowNotification", b =>
                {
                    b.HasOne("PrimeApps.Model.Entities.Application.Workflow")
                        .WithOne("SendNotification")
                        .HasForeignKey("PrimeApps.Model.Entities.Application.WorkflowNotification", "SendNotification")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Application.WorkflowTask", b =>
                {
                    b.HasOne("PrimeApps.Model.Entities.Application.Workflow")
                        .WithOne("CreateTask")
                        .HasForeignKey("PrimeApps.Model.Entities.Application.WorkflowTask", "CreateTask")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Application.WorkflowUpdate", b =>
                {
                    b.HasOne("PrimeApps.Model.Entities.Application.Workflow")
                        .WithOne("FieldUpdate")
                        .HasForeignKey("PrimeApps.Model.Entities.Application.WorkflowUpdate", "FieldUpdate")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("PrimeApps.Model.Entities.Application.WorkflowWebhook", b =>
                {
                    b.HasOne("PrimeApps.Model.Entities.Application.Workflow")
                        .WithOne("WebHook")
                        .HasForeignKey("PrimeApps.Model.Entities.Application.WorkflowWebhook", "WebHook")
                        .OnDelete(DeleteBehavior.Cascade);
