        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    field_id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    Combination = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    decimal_places = table.Column<byte>(nullable: false),
                    ...
                    section_column = table.Column<byte>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    column_count = table.Column<byte>(nullable: false),
                    created_at = table.Column<DateTime>(nullable: false),
                    created_by = table.Column<int>(nullable: false),
                    custom_label = table.Column<string>(maxLength: 1000, nullable: true),
                    deleted = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendNotification = table.Column<int>(nullable: true),
                    subject = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    workflow_id = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn),
                    CreateTask = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldUpdate = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    method_type = table.Column<int>(nullable: false),
                    parameters = table.Column<string>(nullable: true),
                    WebHook = table.Column<int>(nullable: true),
                    WorkflowId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_action_button_permissions_action_button_id",
                schema: "public",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_field_permissions_field_id",
                schema: "public",
                table: "field_permissions",
                column: "field_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_section_permissions_section_id",
                schema: "public",
                table: "section_permissions",
                column: "section_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_template_permissions_template_id",
                schema: "public",
                table: "template_permissions",
                column: "template_id");
