...
namespace PrimeApps.Model.Repositories.Interfaces
{
    public interface IRecordRepository : IRepositoryBaseTenant
    {
        ...
        Task<JArray> GetAllById(string moduleName, List<int> recordIds, bool roleBasedEnabled = true, bool isAdmin = false);
        ...
        Task<JObject> RecordPermissionControl(string moduleName, int userId, JObject record, OperationType operation, List<string> removedFields = null, bool customBulkUpdatePermission = false, TenantUser user = null, Module module = null);
    }
}
