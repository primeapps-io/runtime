...
namespace PrimeApps.Model.Repositories.Interfaces
{
	public interface ITemplateRepository : IRepositoryBaseTenant
	{
		...
		Task<ICollection<Template>> GetAllList(LanguageType language, TemplateType templateType = TemplateType.NotSet, TemplateType excelTemplateType = TemplateType.NotSet, string moduleName = "");
